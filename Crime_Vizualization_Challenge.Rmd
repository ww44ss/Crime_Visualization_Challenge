...
```{r map_it, fig.height=9, fig.width=9}
require(ggmap)
require(mapproj)
...
The Map shows locations of crimes, with _red_ data points representing thefts appear to be loaclized to tourist areas, _blue_ data points representing Assault appear localized in the Tenderloin, and _DarkGreen_ data points representing Vehicle Theft are more spread acorss residential areas of the City.    
